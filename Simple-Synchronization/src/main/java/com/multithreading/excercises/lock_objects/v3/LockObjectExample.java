package com.multithreading.excercises.lock_objects.v3;
...
public class LockObjectExample {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println((list1_size + list2_size) == (LOOP_QTY * 4) ? 
			   ...
			   +"\nreduced time execution by not using the synchronization"
			   +"\nnor at the instance level (synchronized at the method signature)"
			   +"\nnor at the properties level: list1 and list2,"
			   +"\n¡ instead using synchronized collections !": 
